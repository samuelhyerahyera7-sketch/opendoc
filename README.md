...
- **Patient file permission model.** File transfer permission is currently "uploader or anyone it's been transferred to may transfer it onward" — separating ownership/view/download/transfer permissions and adding transfer consent records is a separate stage.
